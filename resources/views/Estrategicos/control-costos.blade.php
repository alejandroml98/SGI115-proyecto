@extends('layouts.app', ['activePage' => 'control-costos', 'titlePage' => __('Control costos')])
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title ">Control de costos</h4>
            <p class="card-category"> Control de costos de los insumos en las diferentes etapas de producción</p>
